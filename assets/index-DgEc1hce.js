const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/ServicesSection-CTXQ6V3C.js","assets/react-vendor-DtCFcp6s.js","assets/firebase-vendor-CAk-8R_y.js","assets/ProjectsSection-iLXbVLY_.js","assets/ContactSection-DRVnCyNH.js"])))=>i.map(i=>d[i]);
import{r as j,a as uu,u as Fa,B as hu,R as du,b as Zn,N as ja}from"./react-vendor-DtCFcp6s.js";import{L as fu,_ as mu,C as pu,r as xo,F as gu,a as yu,g as _u,b as vu,c as Tu,d as Gt,e as Eu,f as wu,S as Au,h as Dt,i as Iu,j as bu,k as xu,l as Ru,o as Ma,s as Cu,m as Su}from"./firebase-vendor-CAk-8R_y.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))n(s);new MutationObserver(s=>{for(const o of s)if(o.type==="childList")for(const a of o.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&n(a)}).observe(document,{childList:!0,subtree:!0});function e(s){const o={};return s.integrity&&(o.integrity=s.integrity),s.referrerPolicy&&(o.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?o.credentials="include":s.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function n(s){if(s.ep)return;s.ep=!0;const o=e(s);fetch(s.href,o)}})();var Oa={exports:{}},Ir={};/**
 * @license React
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const kt=(r,t)=>{const e=j.forwardRef(({className:n,...s},o)=>j.createElement(qu,{ref:o,iconNode:t,className:Ba(`lucide-${Mu(So(r))}`,`lucide-${r}`,n),...s}));return e.displayName=So(r),e};/**
 * @license lucide-react v0.484.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ve=new fu("@firebase/firestore");function Re(){return ve.logLevel}function F(r,...t){if(ve.logLevel<=Gt.DEBUG){const e=t.map(Ms);ve.debug(`Firestore (${Oe}): ${r}`,...e)}}function Qt(r,...t){if(ve.logLevel<=Gt.ERROR){const e=t.map(Ms);ve.error(`Firestore (${Oe}): ${r}`,...e)}}function Ne(r,...t){if(ve.logLevel<=Gt.WARN){const e=t.map(Ms);ve.warn(`Firestore (${Oe}): ${r}`,...e)}}function Ms(r){if(typeof r=="string")return r;try{/**
* @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const td=new nt(M.comparator);function Wt(){return td}const Tl=new nt(M.comparator);function cn(...r){let t=Tl;for(const e of r)t=t.insert(e.key,e);return t}function El(r){let t=Tl;return r.forEach((e,n)=>t=t.insert(e,n.overlayedDocument)),t}function ye(){return mn()}function wl(){return mn()}function mn(){return new Ee(r=>r.toString(),(r,t)=>r.isEqual(t))}const ed=new nt(M.comparator),nd=new lt(M.comparator);function K(...r){let t=nd;for(const e of r)t=t.add(e);return t}const rd=new lt(G);function sd(){return rd}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Fd{constructor(t){this.Tt=t}}function jd(r){const t=Pd({parent:r.parent,structuredQuery:r.structuredQuery});return r.limitType==="LAST"?Is(t,t.limit,"L"):t}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class de{constructor(t,e,n){this.converter=e,this._query=n,this.type="query",this.firestore=t}withConverter(t){return new de(this.firestore,t,this._query)}}class At{constructor(t,e,n){this.converter=e,this._key=n,this.type="document",this.firestore=t}get _path(){return this._key.path}get id(){return this._key.path.lastSegment()}get path(){return this._key.path.canonicalString()}get parent(){return new ne(this.firestore,this.converter,this._key.path.popLast())}withConverter(t){return new At(this.firestore,t,this._key)}}class ne extends de{constructor(t,e,n){super(t,e,Cr(n)),this._path=n,this.type="collection"}get id(){return this._query.path.lastSegment()}get path(){return this._query.path.canonicalString()}get parent(){const t=this._path.popLast();return t.isEmpty()?null:new At(this.firestore,null,new M(t))}withConverter(t){return new ne(this.firestore,t,this._path)}}function uc(r,t,...e){if(r=Dt(r),lc("collection","path",t),r instanceof Or){const n=et.fromString(t,...e);return Ia(n),new ne(r,null,n)}{if(!(r instanceof At||r instanceof ne))throw new L(C.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const n=r._path.child(et.fromString(t,...e));return Ia(n),new ne(r.firestore,null,n)}}function Et(r,t,...e){if(r=Dt(r),arguments.length===1&&(t=Za.newId()),lc("doc","path",t),r instanceof Or){const n=et.fromString(t,...e);return Aa(n),new At(r,null,new M(n))}{if(!(r instanceof At||r instanceof ne))throw new L(C.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const n=r._path.child(et.fromString(t,...e));return Aa(n),new At(r.firestore,r instanceof ne?r.converter:null,new M(n))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
