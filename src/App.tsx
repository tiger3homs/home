    ...
    <div className={`min-h-screen bg-gradient-to-br from-gray-900 to-gray-800 text-white ltr`}>
      <header className="container mx-auto px-4 py-16 md:py-32">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p
            ...
            style={{ pointerEvents: 'none', userSelect: 'none', color: 'var(--text-color)' }}
          >
      ...
      <section className="container mx-auto px-4 py-16 bg-gray-800/50 backdrop-blur-sm">
        <div className="max-w-3xl mx-auto">
          ...
          <h2 className="text-3xl font-bold text-center mb-8 text-titel" style={{ color: 'var(--title-color)' }}>{t.about.title}</h2>
          {/* Use text-secondary or a lighter gray for About text */}
          <p className="text-secondary text-lg leading-relaxed" style={{ color: 'var(--text-color)' }}>
            {t.about.description}
          </p>
        </div>
      </section>
      ...
      <footer className="container mx-auto px-4 py-8 text-center text-secondary">
        <p style={{ color: 'var(--text-color)' }}>{t.generalInfo.footerText}</p>
        <div className="mt-4">
